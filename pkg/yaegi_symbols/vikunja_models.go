// Code generated by 'yaegi extract code.vikunja.io/api/pkg/models'. DO NOT EDIT.
...
func init() {
	Symbols["code.vikunja.io/api/pkg/models/models"] = map[string]reflect.Value{
		...
		"BuildOverview":                                    reflect.ValueOf(models.BuildOverview),
		"CanDoAPIRoute":                                    reflect.ValueOf(models.CanDoAPIRoute),
		"CanReadNotification":                              reflect.ValueOf(models.CanReadNotification),
		"ChangeUserPassword":                               reflect.ValueOf(models.ChangeUserPassword),
		"ClearProjectBackground":                           reflect.ValueOf(models.ClearProjectBackground),
		...
		"DeleteUserAsAdmin":                                reflect.ValueOf(models.DeleteUserAsAdmin),
		...
		"ErrCodeFilterTooComplex":                          reflect.ValueOf(constant.MakeFromLiteral("4033", token.INT, 0)),
		...
		"ErrCodeInvalidBulkTaskCreationCount":              reflect.ValueOf(constant.MakeFromLiteral("4030", token.INT, 0)),
		...
		"ErrCodeInvalidRefreshToken":                       reflect.ValueOf(constant.MakeFromLiteral("16002", token.INT, 0)),
		...
		"ErrCodeInvalidTaskInBulkCreation":                 reflect.ValueOf(constant.MakeFromLiteral("4031", token.INT, 0)),
		"ErrCodeInvalidTaskRepeatInterval":                 reflect.ValueOf(constant.MakeFromLiteral("4029", token.INT, 0)),
		"ErrCodeInvalidTimeEntryFilterField":               reflect.ValueOf(constant.MakeFromLiteral("18003", token.INT, 0)),
		"ErrCodeInvalidTimeEntryFilterValue":               reflect.ValueOf(constant.MakeFromLiteral("18004", token.INT, 0)),
		...
		"ErrCodeNoRunningTimer":                            reflect.ValueOf(constant.MakeFromLiteral("18005", token.INT, 0)),
		"ErrCodeOAuthClientNotFound":                       reflect.ValueOf(constant.MakeFromLiteral("17001", token.INT, 0)),
		"ErrCodeOAuthCodeExpired":                          reflect.ValueOf(constant.MakeFromLiteral("17005", token.INT, 0)),
		"ErrCodeOAuthCodeInvalid":                          reflect.ValueOf(constant.MakeFromLiteral("17004", token.INT, 0)),
		"ErrCodeOAuthInvalidGrantType":                     reflect.ValueOf(constant.MakeFromLiteral("17007", token.INT, 0)),
		"ErrCodeOAuthInvalidRedirectURI":                   reflect.ValueOf(constant.MakeFromLiteral("17002", token.INT, 0)),
		"ErrCodeOAuthMissingPKCE":                          reflect.ValueOf(constant.MakeFromLiteral("17003", token.INT, 0)),
		"ErrCodeOAuthPKCEVerifyFailed":                     reflect.ValueOf(constant.MakeFromLiteral("17006", token.INT, 0)),
		...
		"ErrCodeParentProjectIsArchived":                   reflect.ValueOf(constant.MakeFromLiteral("3016", token.INT, 0)),
		...
		"ErrCodeProjectHasNoBackground":                    reflect.ValueOf(constant.MakeFromLiteral("3015", token.INT, 0)),
		...
		"ErrCodeRefreshTokenAlreadyUsed":                   reflect.ValueOf(constant.MakeFromLiteral("16004", token.INT, 0)),
		...
		"ErrCodeSessionExpired":                            reflect.ValueOf(constant.MakeFromLiteral("16003", token.INT, 0)),
		...
		"ErrCodeTimeEntryAlreadyEnded":                     reflect.ValueOf(constant.MakeFromLiteral("18006", token.INT, 0)),
		"ErrCodeTimeEntryDoesNotExist":                     reflect.ValueOf(constant.MakeFromLiteral("18001", token.INT, 0)),
		"ErrCodeTimeEntryEndBeforeStart":                   reflect.ValueOf(constant.MakeFromLiteral("18007", token.INT, 0)),
		"ErrCodeTimeEntryInvalidContainer":                 reflect.ValueOf(constant.MakeFromLiteral("18002", token.INT, 0)),
		...
		"ErrCodeUserDataExportDoesNotExist":                reflect.ValueOf(constant.MakeFromLiteral("19001", token.INT, 0)),
		...
		"GetAPITokenRoutes":                                reflect.ValueOf(models.GetAPITokenRoutes),
		"GetAllParentProjects":                             reflect.ValueOf(models.GetAllParentProjects),
		"GetAndDeleteOAuthCode":                            reflect.ValueOf(models.GetAndDeleteOAuthCode),
		...
		"GetDeletedTasksSince":                             reflect.ValueOf(models.GetDeletedTasksSince),
		"GetLabelSimple":                                   reflect.ValueOf(models.GetLabelSimple),
		"GetLabelsByTaskIDs":                               reflect.ValueOf(models.GetLabelsByTaskIDs),
		"GetLabelsForUser":                                 reflect.ValueOf(models.GetLabelsForUser),
		...
		"GetProjectSimpleByIdentifier":                     reflect.ValueOf(models.GetProjectSimpleByIdentifier),
		...
		"GetSubscriptionsForDeletedTask":                   reflect.ValueOf(models.GetSubscriptionsForDeletedTask),
		...
		"GetTaskAttachmentForDownload":                     reflect.ValueOf(models.GetTaskAttachmentForDownload),
		"GetTaskByIDSimple":                                reflect.ValueOf(models.GetTaskByIDSimple),
		"GetTaskByProjectAndIndex":                         reflect.ValueOf(models.GetTaskByProjectAndIndex),
		...
		"IsErrFilterTooComplex":                            reflect.ValueOf(models.IsErrFilterTooComplex),
		...
		"IsErrInvalidBulkTaskCreationCount":                reflect.ValueOf(models.IsErrInvalidBulkTaskCreationCount),
		...
		"IsErrInvalidRefreshToken":                         reflect.ValueOf(models.IsErrInvalidRefreshToken),
		...
		"IsErrInvalidTaskInBulkCreation":                   reflect.ValueOf(models.IsErrInvalidTaskInBulkCreation),
		"IsErrInvalidTaskRepeatInterval":                   reflect.ValueOf(models.IsErrInvalidTaskRepeatInterval),
		"IsErrInvalidTimeEntryFilterField":                 reflect.ValueOf(models.IsErrInvalidTimeEntryFilterField),
		"IsErrInvalidTimeEntryFilterValue":                 reflect.ValueOf(models.IsErrInvalidTimeEntryFilterValue),
		...
		"IsErrNoRunningTimer":                              reflect.ValueOf(models.IsErrNoRunningTimer),
		"IsErrOAuthClientNotFound":                         reflect.ValueOf(models.IsErrOAuthClientNotFound),
		"IsErrOAuthCodeExpired":                            reflect.ValueOf(models.IsErrOAuthCodeExpired),
		"IsErrOAuthCodeInvalid":                            reflect.ValueOf(models.IsErrOAuthCodeInvalid),
		"IsErrOAuthInvalidGrantType":                       reflect.ValueOf(models.IsErrOAuthInvalidGrantType),
		"IsErrOAuthInvalidRedirectURI":                     reflect.ValueOf(models.IsErrOAuthInvalidRedirectURI),
		"IsErrOAuthMissingPKCE":                            reflect.ValueOf(models.IsErrOAuthMissingPKCE),
		"IsErrOAuthPKCEVerifyFailed":                       reflect.ValueOf(models.IsErrOAuthPKCEVerifyFailed),
		...
		"IsErrParentProjectIsArchived":                     reflect.ValueOf(models.IsErrParentProjectIsArchived),
		...
		"IsErrProjectHasNoBackground":                      reflect.ValueOf(models.IsErrProjectHasNoBackground),
		...
		"IsErrRefreshTokenAlreadyUsed":                     reflect.ValueOf(models.IsErrRefreshTokenAlreadyUsed),
		...
		"IsErrSessionExpired":                              reflect.ValueOf(models.IsErrSessionExpired),
		...
		"IsErrTimeEntryAlreadyEnded":                       reflect.ValueOf(models.IsErrTimeEntryAlreadyEnded),
		"IsErrTimeEntryDoesNotExist":                       reflect.ValueOf(models.IsErrTimeEntryDoesNotExist),
		"IsErrTimeEntryEndBeforeStart":                     reflect.ValueOf(models.IsErrTimeEntryEndBeforeStart),
		"IsErrTimeEntryInvalidContainer":                   reflect.ValueOf(models.IsErrTimeEntryInvalidContainer),
		...
		"IsErrUserDataExportDoesNotExist":                  reflect.ValueOf(models.IsErrUserDataExportDoesNotExist),
		...
		"RegisterTaskCleanupCron":                          reflect.ValueOf(models.RegisterTaskCleanupCron),
		...
		"SetUserPasswordAsAdmin":                           reflect.ValueOf(models.SetUserPasswordAsAdmin),
		"SetUserStatusAsAdmin":                             reflect.ValueOf(models.SetUserStatusAsAdmin),
		...
		"StopRunningTimer":                                 reflect.ValueOf(models.StopRunningTimer),
		...
		"TaskCollectionExpandTimeEntriesCount":             reflect.ValueOf(models.TaskCollectionExpandTimeEntriesCount),
		"TaskDeleteRetention":                              reflect.ValueOf(models.TaskDeleteRetention),
		...
		"APITokenExpiringDayNotification":              reflect.ValueOf((*models.APITokenExpiringDayNotification)(nil)),
		"APITokenExpiringWeekNotification":             reflect.ValueOf((*models.APITokenExpiringWeekNotification)(nil)),
		"APITokenIssuedEvent":                          reflect.ValueOf((*models.APITokenIssuedEvent)(nil)),
		"APITokenRevokedEvent":                         reflect.ValueOf((*models.APITokenRevokedEvent)(nil)),
		"APITokenRoute":                                reflect.ValueOf((*models.APITokenRoute)(nil)),
		"APITokenUsedEvent":                            reflect.ValueOf((*models.APITokenUsedEvent)(nil)),
		"AdminAccessDeniedEvent":                       reflect.ValueOf((*models.AdminAccessDeniedEvent)(nil)),
		"AdminProjectList":                             reflect.ValueOf((*models.AdminProjectList)(nil)),
		"AdminProjectOwnerChangedEvent":                reflect.ValueOf((*models.AdminProjectOwnerChangedEvent)(nil)),
		"AdminUserAdminGrantedEvent":                   reflect.ValueOf((*models.AdminUserAdminGrantedEvent)(nil)),
		"AdminUserAdminRevokedEvent":                   reflect.ValueOf((*models.AdminUserAdminRevokedEvent)(nil)),
		"AdminUserCreatedEvent":                        reflect.ValueOf((*models.AdminUserCreatedEvent)(nil)),
		"AdminUserDeletedEvent":                        reflect.ValueOf((*models.AdminUserDeletedEvent)(nil)),
		"AdminUserPasswordResetSentEvent":              reflect.ValueOf((*models.AdminUserPasswordResetSentEvent)(nil)),
		"AdminUserPasswordSetEvent":                    reflect.ValueOf((*models.AdminUserPasswordSetEvent)(nil)),
		...
		"ErrFilterTooComplex":                          reflect.ValueOf((*models.ErrFilterTooComplex)(nil)),
		...
		"ErrInvalidBulkTaskCreationCount":              reflect.ValueOf((*models.ErrInvalidBulkTaskCreationCount)(nil)),
		...
		"ErrInvalidRefreshToken":                       reflect.ValueOf((*models.ErrInvalidRefreshToken)(nil)),
		...
		"ErrInvalidTaskInBulkCreation":                 reflect.ValueOf((*models.ErrInvalidTaskInBulkCreation)(nil)),
		"ErrInvalidTaskRepeatInterval":                 reflect.ValueOf((*models.ErrInvalidTaskRepeatInterval)(nil)),
		"ErrInvalidTimeEntryFilterField":               reflect.ValueOf((*models.ErrInvalidTimeEntryFilterField)(nil)),
		"ErrInvalidTimeEntryFilterValue":               reflect.ValueOf((*models.ErrInvalidTimeEntryFilterValue)(nil)),
		...
		"ErrNoRunningTimer":                            reflect.ValueOf((*models.ErrNoRunningTimer)(nil)),
		"ErrOAuthClientNotFound":                       reflect.ValueOf((*models.ErrOAuthClientNotFound)(nil)),
		"ErrOAuthCodeExpired":                          reflect.ValueOf((*models.ErrOAuthCodeExpired)(nil)),
		"ErrOAuthCodeInvalid":                          reflect.ValueOf((*models.ErrOAuthCodeInvalid)(nil)),
		"ErrOAuthInvalidGrantType":                     reflect.ValueOf((*models.ErrOAuthInvalidGrantType)(nil)),
		"ErrOAuthInvalidRedirectURI":                   reflect.ValueOf((*models.ErrOAuthInvalidRedirectURI)(nil)),
		"ErrOAuthMissingPKCE":                          reflect.ValueOf((*models.ErrOAuthMissingPKCE)(nil)),
		"ErrOAuthPKCEVerifyFailed":                     reflect.ValueOf((*models.ErrOAuthPKCEVerifyFailed)(nil)),
		...
		"ErrParentProjectIsArchived":                   reflect.ValueOf((*models.ErrParentProjectIsArchived)(nil)),
		...
		"ErrProjectHasNoBackground":                    reflect.ValueOf((*models.ErrProjectHasNoBackground)(nil)),
		...
		"ErrRefreshTokenAlreadyUsed":                   reflect.ValueOf((*models.ErrRefreshTokenAlreadyUsed)(nil)),
		...
		"ErrSessionExpired":                            reflect.ValueOf((*models.ErrSessionExpired)(nil)),
		...
		"ErrTimeEntryAlreadyEnded":                     reflect.ValueOf((*models.ErrTimeEntryAlreadyEnded)(nil)),
		"ErrTimeEntryDoesNotExist":                     reflect.ValueOf((*models.ErrTimeEntryDoesNotExist)(nil)),
		"ErrTimeEntryEndBeforeStart":                   reflect.ValueOf((*models.ErrTimeEntryEndBeforeStart)(nil)),
		"ErrTimeEntryInvalidContainer":                 reflect.ValueOf((*models.ErrTimeEntryInvalidContainer)(nil)),
		...
		"ErrUserDataExportDoesNotExist":                reflect.ValueOf((*models.ErrUserDataExportDoesNotExist)(nil)),
		...
		"Overview":                                     reflect.ValueOf((*models.Overview)(nil)),
		...
		"SendTaskCreatedNotification":                  reflect.ValueOf((*models.SendTaskCreatedNotification)(nil)),
		...
		"SessionOIDCData":                              reflect.ValueOf((*models.SessionOIDCData)(nil)),
		"ShareCounts":                                  reflect.ValueOf((*models.ShareCounts)(nil)),
		...
		"TaskCreatedNotification":                      reflect.ValueOf((*models.TaskCreatedNotification)(nil)),
		...
		"TasksBatchCreatedEvent":                       reflect.ValueOf((*models.TasksBatchCreatedEvent)(nil)),
		...
		"TimeEntry":                                    reflect.ValueOf((*models.TimeEntry)(nil)),
		"TimeEntryCreatedEvent":                        reflect.ValueOf((*models.TimeEntryCreatedEvent)(nil)),
		"TimeEntryDeletedEvent":                        reflect.ValueOf((*models.TimeEntryDeletedEvent)(nil)),
		"TimeEntryUpdatedEvent":                        reflect.ValueOf((*models.TimeEntryUpdatedEvent)(nil)),
		...
		"UpdateTasksBatchInSavedFilterViews":           reflect.ValueOf((*models.UpdateTasksBatchInSavedFilterViews)(nil)),
		"UserDataExportRequestedEvent":                 reflect.ValueOf((*models.UserDataExportRequestedEvent)(nil)),
		"UserExportStatus":                             reflect.ValueOf((*models.UserExportStatus)(nil)),
		"UserGeneralSettings":                          reflect.ValueOf((*models.UserGeneralSettings)(nil)),
		...
		"WebhookDeliveryEvent":                         reflect.ValueOf((*models.WebhookDeliveryEvent)(nil)),
		"WebhookDeliveryListener":                      reflect.ValueOf((*models.WebhookDeliveryListener)(nil)),
